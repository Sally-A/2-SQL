...
INSERT INTO categories VALUES (1, 'Beverages', 'Soft drinks, coffees, teas, beers, and ales', 'https://images.freeimages.com/images/large-previews/1fe/colour-drinks-2-1522693.jpg');
INSERT INTO categories VALUES (2, 'Condiments', 'Sweet and savory sauces, relishes, spreads, and seasonings', 'https://images.freeimages.com/images/large-previews/474/ketchup-1324030.jpg');
INSERT INTO categories VALUES (3, 'Confections', 'Desserts, candies, and sweet breads', 'https://images.freeimages.com/images/large-previews/b20/pie-1325497.jpg');
INSERT INTO categories VALUES (4, 'Dairy Products', 'Cheeses', 'https://images.freeimages.com/images/large-previews/fbb/cheese-1325745.jpg');
INSERT INTO categories VALUES (5, 'Grains/Cereals', 'Breads, crackers, pasta, and cereal', 'https://images.freeimages.com/images/large-previews/6f7/cereal-1564787.jpg');
INSERT INTO categories VALUES (6, 'Meat/Poultry', 'Prepared meats', 'https://images.freeimages.com/images/large-previews/b95/chicken-1576345.jpg');
INSERT INTO categories VALUES (7, 'Produce', 'Dried fruit and bean curd', 'https://images.freeimages.com/images/large-previews/b5a/fresh-vegetables-1187928.jpg');
INSERT INTO categories VALUES (8, 'Seafood', 'Seaweed and fish', 'https://images.freeimages.com/images/large-previews/2c0/fish-1565795.jpg');
...
SELECT pg_catalog.setval(pg_get_serial_sequence('categories', 'category_id'), MAX(category_id)) FROM categories;
SELECT pg_catalog.setval(pg_get_serial_sequence('employees', 'employee_id'), MAX(employee_id)) FROM employees;
SELECT pg_catalog.setval(pg_get_serial_sequence('orders', 'order_id'), MAX(order_id)) FROM orders;
SELECT pg_catalog.setval(pg_get_serial_sequence('products', 'product_id'), MAX(product_id)) FROM products;
SELECT pg_catalog.setval(pg_get_serial_sequence('region', 'region_id'), MAX(region_id)) FROM region;
SELECT pg_catalog.setval(pg_get_serial_sequence('shippers', 'shipper_id'), MAX(shipper_id)) FROM shippers;
SELECT pg_catalog.setval(pg_get_serial_sequence('suppliers', 'supplier_id'), MAX(supplier_id)) FROM suppliers;
